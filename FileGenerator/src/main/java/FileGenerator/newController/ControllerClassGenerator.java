...
public class ControllerClassGenerator {
    ...
    public static String generateShowUpdateProductFormEndpoint(JSONArray classesList, String firstClassName, String secondClassName) {
        ...
        stringBuilder
                ...
                .append(NEW_LINE)
                .append("model.addAttribute(\"").append(listName).append("\", items)").append(END_STATEMENT)
                .append(NEW_LINE)
                .append("model.addAttribute(\"").append(listName).append("Size").append("\", items").append(".size())").append(END_STATEMENT)
                .append(NEW_LINE)
